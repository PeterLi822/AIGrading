...
def lambda_handler(event, context):
    ...
    try:
        ...
        send_email(student_email, professor_email, student_name, assignment, student_number, course_code, overall_grade, section_number, professor_name, new_key)
...
def send_email(student_email, professor_email, student_name, assignment, student_number, course_code, overall_grade, section_number, professor_name, key):
